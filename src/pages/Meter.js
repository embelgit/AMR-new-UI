...
// const meterStatuses = ["ACTIVE", "INACTIVE", "FAULTY", "REPLACED", "MAINTENANCE"];
...
//       alert("Meter Number and Assigned Username are required");
//       return;
//     }

//     setMeters([...meters, { ...form, id: Date.now().toString() }]);
//     setShowModal(false);
//   };
...
//               <th className="px-4 py-2">Meter Number</th>
...
//                 <td className="px-4 py-2">{m.assignedToUsername} ({m.assignedToRole})</td>
//                 <td className="px-4 py-2">{m.siteName}</td>
//                 <td className="px-4 py-2">{m.city}</td>
//                 <td className="px-4 py-2">{m.status}</td>
//                 <td className="px-4 py-2">{m.batteryLevel}%</td>
//                 <td className="px-4 py-2">{m.online ? "Online" : "Offline"}</td>
//               </tr>
//             ))}
//             {meters.length === 0 && (
//               <tr>
...
//           <div className="bg-white rounded-lg shadow-lg w-96 p-6 space-y-3">
//             <h2 className="text-lg font-semibold">Create Meter</h2>
...
//                 className="w-full border px-3 py-2 rounded bg-white text-left flex items-center justify-between focus:ring-2 focus:ring-blue-500 outline-none"
//             >
...
//                                         </button>
//                                         <button onClick={() => deleteMeter(m.id)}>
...
//                     <div className="bg-white w-96 rounded-lg shadow-lg p-6 my-8 relative overflow-visible">
...
//                             className="mb-3"
//                             value={form.meterType}
//                             onChange={(value) => setForm({ ...form, meterType: value })}
...
//                             className="mb-3"
//                             value={form.assignedToRole}
//                             onChange={(value) => setForm({ ...form, assignedToRole: value })}
...
//                             options={meterStatuses.map(s => ({ value: s, label: s }))}
