    ...
    <div className="px-4 py-6 md:p-6">
      <div className="flex gap-4 mb-6 border-b border-gray-200">
        <button
          ...
          className={`pb-3 px-4 text-sm font-medium transition-colors relative ${activeTab === "devices"
        ...
        <button
          ...
          className={`pb-3 px-4 text-sm font-medium transition-colors relative ${activeTab === "meters"
            ? "text-blue-600 border-b-2 border-blue-600"
            : "text-gray-500 hover:text-gray-700"
            }`}
        >
